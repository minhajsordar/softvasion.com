...
export default function serviceSection() {
  ...
  SERVICES START
    =============================*/}
                <section className="services mt_120 xs_mt_80 pt_115 xs_pt_75 pb_95 xs_pb_55">
                        ...
                        <div className="row">
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>ওয়েব ডিজাইন ও ডেভেলপমেন্ট</h2>
                                    <p>
                                        আমাদের ওয়েব ডিজাইন ও&nbsp;
                                        <span
                                            style={{
                                                color: "rgb(33, 37, 41)",
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <p />
                                    <div>
                                        আমাদের সফটওয়্যার ডেভেলপমেন্ট প্যাকেজ শুরু ১০০০০ টাকা থেকে
                                    </div>
                                    <p />
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>এসইও এর সকল সার্ভিস</h2>
                                    <p />
                                    <p>আমাদের এসইও এর সকল সার্ভিস প্যাকেজ শুরু ৩০০০ টাকা থেকে</p>
                                    <p />
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>ডোমেন, হোস্টিং ও সার্ভার</h2>
                                    <p />
                                    <p>আমাদের ডোমেন এবং হোস্টিং এর প্যাকেজ শুরু ৩০০০ টাকা থেকে</p>
                                    <p />
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>সোশ্যাল মিডিয়া মার্কেটিং</h2>
                                    <p />
                                    <p>আমাদের সোশ্যাল মিডিয়া মার্কেটিং প্যাকেজ শুরু ২০০০ টাকা থেকে</p>
                                    <p />
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>গ্রাফিক্স ডিজাইন এর সার্ভিস</h2>
                                    <p />
                                    <p>আমাদের গ্রাফিক্স ডিজাইন এর সকল প্যাকেজ শুরু ৫০০০ টাকা থেকে</p>
                                    <p />
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>UI/UX ডিজাইন এর সার্ভিস</h2>
                                    <p />
                                    <p>
                                        আমাদের&nbsp;UI/UX ডিজাইন এর সার্ভিস এর প্যাকেজ শুরু ১০০০ টাকা থেকে
                                    </p>
                                    <p />
                            ...
                            >
                                <div className="service_item">
                                    ...
                                    <h2>প্রোডাক্ট ব্রান্ডিং ও ডিজাইন</h2>
                                    <p />
                                    <p>
                                        আমাদের প্রোডাক্ট ব্রান্ডিং ও ডিজাইন প্যাকেজ শুরু ৮০০০ টাকা থেকে
                                    </p>
                                    <p />
